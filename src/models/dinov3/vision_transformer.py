...
from src.models.dinov3.rope_position_encoding import RopePositionEmbedding
from src.models.dinov3.patch_embed import PatchEmbed
from src.models.dinov3.block import SelfAttentionBlock
from src.models.dinov3.rms_norm import RMSNorm
from src.models.dinov3.layer_scale import LayerScale
from src.models.dinov3.ffn_layers import Mlp, SwiGLUFFN
from src.models.dinov3.utils import named_apply
from src.utils import apply_masks, apply_masks_with_prefix
...
class DinoVisionTransformer(nn.Module):
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if masks is not None:
                ...
                for rope_component in rope_sincos:  # Loop over sin and cos
                    # rope_component shape: [H*W, head_dim]
                    mask_indices = masks[0].squeeze(0)  # [num_visible] 
                    rope_masked = rope_component[mask_indices]  # [num_visible, head_dim]
                    rope_sincos_masked.append(rope_masked)
                
                rope_sincos = tuple(rope_sincos_masked)
    ...
    def get_intermediate_layers(
        ...
        *,
        ...
        outputs = self._get_intermediate_layers_not_chunked(x=x, masks=masks, n=n)
        if norm:
            outputs_normed = []
            for out in outputs:
